...
var taskInput=document.getElementById("new-task__add");//Add a new task.
...
var editTask=function(){
    ...
    var editInput=listItem.querySelector(".section__task-input");
    var label=listItem.querySelector(".section__task-label");
    var editBtn=listItem.querySelector(".button--edit");
    var containsClass=listItem.classList.contains("section__task-item--edit");
    ...
    listItem.classList.toggle("section__task-item--edit");
};
